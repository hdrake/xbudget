...
New here? The :doc:`quickstart` closes a budget in about thirty lines, with made-up data and no downloads. :doc:`recipes` is the reference for writing a `.yaml` file for your own model.
